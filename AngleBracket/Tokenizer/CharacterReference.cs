...
namespace AngleBracket.Tokenizer
{
    internal static class CharacterReference
    {
        ...
        internal static Dictionary<int, int> NumericMapping = new Dictionary<int, int>()
        {
            { 0x80, 0x20AC }, // euro sign
            { 0x82, 0x201A }, // single low-9 quotation mark
            { 0x83, 00192 }, // latin small letter f with hook
            { 0x84, 0x201E }, // double low-9 quotation mark
            { 0x85, 0x2026 }, // horizontal ellipsis
            { 0x86, 0x2020 }, // dagger
            { 0x87, 0x2021 }, // double dagger
            { 0x88, 0x2C6 }, // modifier letter circumflex accent
            { 0x89, 0x2030 }, // per mille sign
            { 0x8A, 0x160 }, // latin capital letter s with caron
            { 0x8B, 0x2039 }, // single left-pointing angle quotation mark
            { 0x8C, 0x152 }, // latin capital ligature oe
            { 0x8E, 0x17D }, // latin capital letter z with caron
            ...
            { 0x96, 0x2013 }, // en dash
            { 0x97, 0x2014 }, // em dash
            { 0x98, 0x2DC }, // small tilde
            { 0x99, 0x2122 }, // trade mark sign
            { 0x9A, 0x161 }, // latin small letter s with caron
            { 0x9B, 0x203A }, // single right-pointing angle quotation mark
            { 0x9C, 0x153 }, // latin small ligature oe
            { 0x9E, 0x17E }, // latin small letter z with caron
            { 0x9F, 0x178 }, // latin capital letter y with diaeresis
        };

        // WHATWG 13.5 "Named character references"
        internal static Dictionary<string, string> NamedMapping = new Dictionary<string, string>()
        {
            { "AElig", "\x00C6" },
            { "AElig;", "\x00C6" },
            { "AMP", "\x0026" },
